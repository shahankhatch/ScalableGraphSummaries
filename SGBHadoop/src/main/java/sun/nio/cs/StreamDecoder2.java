...
public class StreamDecoder2 extends Reader
{
 
	public static int test = 1;
    public static int MIN_BYTE_BUFFER_SIZE = 32;
    public static int DEFAULT_BYTE_BUFFER_SIZE = 8192*32;
    ...
    public static StreamDecoder2 forInputStreamReader(InputStream in,
                                                     Object lock,
                                                     String charsetName)
        throws UnsupportedEncodingException
    {
        ...
        try {
            if (Charset.isSupported(csn))
                return new StreamDecoder2(in, lock, Charset.forName(csn));
    ...
    public static StreamDecoder2 forInputStreamReader(InputStream in,
                                                     ...
                                                     Charset cs)
    {
        return new StreamDecoder2(in, lock, cs);
    }
    ...
    public static StreamDecoder2 forInputStreamReader(InputStream in,
                                                     ...
                                                     CharsetDecoder dec)
    {
        return new StreamDecoder2(in, lock, dec);
    }


    // Factory for java.nio.channels.Channels.newReader

    public static StreamDecoder2 forDecoder(ReadableByteChannel ch,
                                           CharsetDecoder dec,
                                           int minBufferCap)
    {
        return new StreamDecoder2(ch, dec, minBufferCap);
    }
    ...
    StreamDecoder2(InputStream in, Object lock, Charset cs) {
        this(in, lock,
         cs.newDecoder()
    ...
    StreamDecoder2(InputStream in, Object lock, CharsetDecoder dec) {
        super(lock);
        this.cs = dec.charset();
        this.decoder = dec;
    ...
    StreamDecoder2(ReadableByteChannel ch, CharsetDecoder dec, int mbc) {
        this.in = null;
        this.ch = ch;
        this.decoder = dec;
        this.cs = dec.charset();
